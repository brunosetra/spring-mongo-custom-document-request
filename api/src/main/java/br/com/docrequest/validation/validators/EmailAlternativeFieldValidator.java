...
@Component
public class EmailAlternativeFieldValidator extends AbstractFieldValidator {
    ...
    public DocRequestFieldType getType() {
        return DocRequestFieldType.EMAIL_ALTERNATIVE;
    }
    ...
    protected Optional<FieldValidationError> validateValue(String fieldName, Object value,
        ...
        if (!EMAIL_PATTERN.matcher(email).matches()) {
            return Optional.of(buildError(fieldName, metadata, "ERR_EMAIL_ALT_INVALID",
